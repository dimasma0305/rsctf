...
wide desktop (1920×1080), desktop (1440×1100), laptop (1024×768), tablet
(768×1024), mobile (390×844), and compact mobile (320×568) sizes. For every
render it saves the actual viewport plus an expanded full-content screenshot
that opens nested vertical scroll regions. It runs axe, checks responsive
overflow and viewport escapes, heading structure, control names and target
spacing, and records browser exceptions and HTTP 5xx responses.
