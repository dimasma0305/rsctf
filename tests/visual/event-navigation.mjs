...
const geometry = `(() => {
 ...
 return {header:rect('[data-event-workspace-header]'), title:rect('[data-event-workspace-header] h1'), nav:rect('[data-event-tabs]'), track:rect('[data-event-tabs] nav'), rail:rect('#primary-navigation-rail'), mobileHeader:rect('header[data-guide-boundary="top-shell"]')};
})()`
...
try {
 ...
 for(const [name,width,height] of [['desktop',1600,1000],['wide',1920,1080],['laptop',1024,768],['mobile',390,844],['compact',320,568]]) {
