...
description: |
  Audit and rewrite content to remove common AI-writing patterns. Use only when
  the user explicitly asks to remove AI-isms, audit AI tells, make prose sound
  less like AI, or reduce detector-facing patterns. This is a writing-quality
  edit, not a guarantee of detector results. Supports detect, rewrite, and
  edit-in-place modes plus optional voice profiles.
license: MIT
metadata:
  author: Conor Bronsdon
  tags: writing editing voice quality
  agentskills_spec: "1.0"
  compatibility: OpenAI Codex; no external tools or APIs required
  upstream: https://github.com/conorbronsdon/avoid-ai-writing
  upstream-version: "3.15.0"
  upstream-commit: 500ff59006f19c27120c5ddbd9b56fc3d937b6bf
  local-adaptation: Codex tool names and repository writing-skill routing
---
...
2. **Edit in place**: apply minimal, targeted fixes to the flagged spans with `apply_patch`, leaving already-human passages untouched
...
- Tracking parameters that AI tools auto-append to URLs they generate, surviving copy-paste into published content: `utm_source=chatgpt.com`, `utm_source=copilot.com`, `utm_source=openai`, `utm_source=perplexity.ai`, `referrer=grok.com`. Same logic as citation markup leaks — the presence of the parameter is the signature, regardless of what the surrounding text reads like.
