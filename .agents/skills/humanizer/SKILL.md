...
name: humanizer
description: |
  Remove signs of AI-generated writing and make prose sound more natural. Use
  only when the user explicitly asks to humanize, de-AI, or naturalize text; do
  not apply automatically to technical or academic writing. Detects inflated
  symbolism, promotional language, superficial analyses, vague attributions,
  formulaic structure, passive voice, and filler phrases.
license: MIT
metadata:
  upstream: https://github.com/blader/humanizer
  upstream-version: "2.8.2"
  upstream-commit: 1b48564898e999219882660237fde01bf4843a0f
---
