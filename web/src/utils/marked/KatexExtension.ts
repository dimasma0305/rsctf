...
function inlineKatex(_options: MarkedOptions, renderer: RendererExtensionFunction): TokenizerAndRendererExtension {
  return {
    name: 'inlineKatex',
    level: 'inline',
    start(src: string) {
...
function blockKatex(_options: MarkedOptions, renderer: RendererExtensionFunction): TokenizerAndRendererExtension {
  return {
    name: 'blockKatex',
    level: 'block',
