...
test('conditional paths are narrowly scoped to boards and split private play projections', () => {
  ...
  assert.equal(isConditionalScoreboardPath('/api/game/7/details/catalog'), true)
  assert.equal(isConditionalScoreboardPath('/api/game/7/details/live'), true)
