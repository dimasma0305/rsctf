          ...
          <TextInput
            ...
            rightSection={
              <ActionIcon
                ...
                onClick={() => !loading && setInviteCode(randomInviteCode())}
              >
                  ...
                  <Accordion.Item value={value} key={value}>
                    <Group gap={4} wrap="nowrap">
                      ...
                      <ActionIcon
                        ...
                        disabled={loading}
                        aria-label={t(
                          'admin.button.games.divisions.remove_challenge',
                          'Remove {{challenge}} override',
                          {
                            challenge: getChallengeTitle(id),
                          }
                        )}
                        onClick={() => handleChallengeSelection(selectedChallenges.filter((item) => item !== value))}
                      >
