    ...
    <>
      ...
      <AdTokenRevealModal
        ...
        warning={t(
          ...
          'This plaintext is available only in this tab. Copy it for your script now — the platform keeps only a hash and cannot show it after reload, logout, or account change. The previous token (if any) has been invalidated. The same token authenticates both /Koth/Token and /Submit.'
        )}
      />
    </>
  )
